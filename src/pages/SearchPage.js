...
import SearchCard from "../components/section/SearchCard";
    ...
    <div className="search__page">
      <nav className="searh__pagenav">
        <div className="container">
          ...
          />
          <div className="search__pagemiddle">
            <input value="New York" />
            <input value="Sep 5 - Oct 22" />
            <input value="1 guest" />
            <button>
              <SearchIcon />
            </button>
          </div>
          <div className="search__pageright">
      ...
      <div className="search__pagecontent">
        <div className="search__pagecontentleft">
          <header>
            <div>
              <p>300+ stays</p>
              <p>&middot;</p>
              <p>Sep 5 - Oct 22 (±2 days)</p>
              <p>&middot;</p>
              <p>1 guest</p>
            </div>
            <h2>Stays in New York</h2>
            <div className="tags">
            ...
            <div className="restrictions">
              <TrackChangesIcon />
              <p>
                Check travel restrictions before booking.Please review and
                follow government travel guidelines. Learn more
              </p>
            </div>
          </header>
          <div className="search__housecard">
            <SearchCard />
            <SearchCard />
            <SearchCard />
            <SearchCard />
        ...
        <div className="search__pagecontentright"></div>
      </div>
    </div>
  );
}
